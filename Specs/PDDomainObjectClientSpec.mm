...
SPEC_BEGIN(PDDomainObjectClientSpec)

describe(@"PDDomainObjectClient", ^{
    __block PDDomainObjectClient *subject;
    ...
    beforeEach(^{
        ...
        subject = [[PDDomainObjectClient alloc] initWithRequester:requester
